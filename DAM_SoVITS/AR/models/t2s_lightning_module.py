...
from AR.models.t2s_model import Text2SemanticEncoder
...
class Text2SemanticLightningModule(LightningModule):
    ...
    def training_step(self, batch: Dict, batch_idx: int):
        ...
        loss, acc = forward(
            batch["phoneme_ids"],
            batch["refer_phoneme_ids_len"],
            batch["target_phoneme_ids_len"],
            batch["semantic_ids"],
            batch["refer_semantic_ids_len"],
            batch["target_semantic_ids_len"],
            batch["emo_feature"],
        )
